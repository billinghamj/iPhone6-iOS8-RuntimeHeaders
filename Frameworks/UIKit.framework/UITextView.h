...
@interface UITextView : UIScrollView <UITextInputControllerDelegate, UITextAutoscrolling, UIKeyboardInput, UITextInputTraits_Private, _UIMultilineTextContentSizing, _UILayoutBaselineUpdating, UITextInput, UITextLinkInteraction> {
    id _private;
