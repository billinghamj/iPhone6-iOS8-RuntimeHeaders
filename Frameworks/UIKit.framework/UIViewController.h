...
@class NSDictionary, UIViewController, UIBarButtonItem, UITransitionView, NSMutableArray, NSString, UIPresentationController, _UILayoutGuide, UIPopoverController, UIResponder, UISearchDisplayController, NSArray, <_UIViewControllerContentViewEmbedding>, UIDropShadowView, NSExtensionContext, UIView, UITabBarItem, <UIViewControllerTransitioningDelegate>, UIStoryboard, NSLayoutConstraint, UITabBarController, UITraitCollection, UINavigationItem, NSBundle, UIScrollView, UINavigationController, NSMapTable, UIWindow, UISplitViewController;

@interface UIViewController : UIResponder <UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, _UIViewServiceDeputy, NSExtensionRequestHandling> {
    UIView *_view;
